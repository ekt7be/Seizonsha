...
namespace GameName1.Skills
{
	class Gun : Skill
	{
		...
		protected override void UseSkill()
		{
			...
			game.Spawn(new Bullet(game, user, game.getBulletSprite(), bulletBounds, damage, damageType, 1, bulletSpeed, user.vectorDirection), bulletBounds.Left, bulletBounds.Top);

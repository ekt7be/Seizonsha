...
namespace GameName1.NPCs
{
	...
	class BossEnemy : GameEntity, AI
	{
		...
		public BossEnemy(Seizonsha game)
			: base(game, Seizonsha.spriteMappings[Static.SPRITE_BASIC_ENEMY_INT], Static.BOSS_ENEMY_WIDTH-1, Static.BOSS_ENEMY_HEIGHT-1, Static.DAMAGE_TYPE_ENEMY, 200)
		{
			base.scale = 1.0f;
			setXPReward(1000);
		...
		void update_moving()
		{
			...
			if (path.Count != 0) {
				...
				if (speed_x!=0 || speed_y!=0){
					...
					allSpeed.Normalize();
					allSpeed = allSpeed * Static.BOSS_ENEMY_SPEED;
